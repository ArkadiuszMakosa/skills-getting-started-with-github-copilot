...
activities = {
    ...
    "Basketball Team": {
        "description": "Join our competitive basketball team and compete in interscholastic leagues",
    ...
    "Drama Club": {
        "description": "Performance arts including acting, stage production, and theater",
